...
class GridDividerDecoration(
    @Px dividerSize: Int, @ColorInt dividerColor: Int, var spanCount: Int
) : RecyclerView.ItemDecoration() {

    private val dividerPaint: Paint = Paint(Paint.ANTI_ALIAS_FLAG)
    ...
    private fun isChildInLastColumn(
        parent: RecyclerView,
        child: View
    ): Boolean {
